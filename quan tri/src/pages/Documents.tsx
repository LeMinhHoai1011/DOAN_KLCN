      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
        <div className="p-4 border-b border-slate-200 flex items-center justify-between bg-slate-50/50">
          ...
          <div className="text-sm text-slate-500">
            Hiển thị 1 - 20 trong tổng số {mockDocuments.length}
          </div>
        </div>
            ...
            <tbody className="text-sm divide-y divide-slate-100">
              {mockDocuments.map((doc) => (
                <tr key={doc.id} className="hover:bg-slate-50 transition-colors group">
                  ...
                  <td className="py-3 px-4 text-right font-medium">{doc.amount.toLocaleString('vi-VN')} đ</td>
                  <td className="py-3 px-4">
                    <span className={clsx(
                      "font-medium",
        ...
        <div className="p-4 border-t border-slate-200 flex justify-between items-center bg-slate-50/50 text-sm">
          ...
          <div className="flex gap-1">
            ...
            <button className="w-8 h-8 flex items-center justify-center rounded-lg bg-white border border-slate-200 text-slate-600 hover:bg-slate-50">2</button>
            <button className="w-8 h-8 flex items-center justify-center rounded-lg bg-white border border-slate-200 text-slate-600 hover:bg-slate-50">3</button>
          </div>
