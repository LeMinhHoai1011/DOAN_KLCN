...
const Upload = () => {
  ...
  const workflowSteps = [
    ...
    {
      id: 4,
      name: 'Trích xuất trường dữ liệu',
      status:
        progress > 60
          ? progress > 80
            ? 'completed'
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFile.size > 10 * 1024 * 1024) {
      setErrorMessage('File không được vượt quá 10MB');
      return;
    }
  ...
  const handleSimulateProcess = async () => {
    ...
    try {
      ...
      // Chuyển sang trang chi tiết document vừa tạo
      setTimeout(() => {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Kéo thả file vào đây để hệ thống tự động xử lý và trích xuất dữ liệu
        </p>
      </div>
        ...
        {processingState === 'idle' ? (
          ...
          >
            ...
            <p className="text-sm text-slate-500 mb-6">
              Hỗ trợ các định dạng: PDF, JPG, PNG, XML (tối đa 10MB)
            </p>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-lg space-y-6">
              ...
              <div className="relative">
                ...
                <div
                  className="absolute left-3.5 top-2 w-0.5 bg-blue-500 transition-all duration-300"
      ...
      {file && processingState === 'idle' && (
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-lg hover:bg-slate-50 transition-colors"
          >
            Hủy
          </button>
          ...
          <button
            ...
            className="px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-sm transition-colors flex items-center gap-2 font-medium"
          >
            <Play size={18} />
            Bắt đầu xử lý
          </button>
